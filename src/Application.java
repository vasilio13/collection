...
public class Application {
    public static void main(String[] args) {
        ...
        employee1.setPastPositions(new PastPosition("engineer", engineering));
        ...
        employee2.setPastPositions(new PastPosition("engineer", engineering));
        ...
        employee3.setPastPositions(new PastPosition("engineer", engineering));
        ...
        employee4.setPastPositions(new PastPosition("economist", finance));
        ...
        employee5.setPastPositions(new PastPosition("economist", finance));
        ...
        employee6.setPastPositions(new PastPosition("economist", finance));
        ...
        employee7.setPastPositions(new PastPosition("HR", personnel));
        ...
        for (Employee i : employees) {
            if (i.getPastPositions().get(0).getDepartment().equals(production)) {
                System.out.println(i);
            }
        }
